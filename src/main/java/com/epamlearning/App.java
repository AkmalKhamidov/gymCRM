...
import com.epamlearning.facade.SignUpFacade;
...
// TODO: add Scanner to get user input and manage the application
...
//
        System.out.println(traineeService.findTrainersByTraineeId(1L));
//
        Trainer trainer1 = trainerService.findById(1L).get();
        Trainer trainer2 = trainerService.findById(2L).get();
//
        Trainee trainee = traineeService.updateTrainers(1L, List.of(trainer1, trainer2)).get();
//
        System.out.println(traineeService.findTrainersByTraineeId(1L));
...
//        List<Trainer> newTrainers = trainerService.findAll().stream().flatMap(Optional::stream).collect(Collectors.toList());

//        trainee = traineeService.updateTrainers(1L, List.of(trainer1, trainer2)).get();
//
